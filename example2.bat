...
echo Running rib-layout optimization Example 2...
echo Results will be written to: %~dp0results\example_2
echo.
"%PYTHON_EXE%" example2.py
set "RUN_STATUS=%ERRORLEVEL%"

echo.
if not "%RUN_STATUS%"=="0" (
    echo [ERROR] Example 2 failed with exit code %RUN_STATUS%.
) else (
