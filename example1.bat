...
echo Running rib-layout optimization Example 1...
echo Results will be written to: %~dp0results\example_1
echo.
"%PYTHON_EXE%" example1.py
set "RUN_STATUS=%ERRORLEVEL%"

echo.
if not "%RUN_STATUS%"=="0" (
    echo [ERROR] Example 1 failed with exit code %RUN_STATUS%.
) else (
